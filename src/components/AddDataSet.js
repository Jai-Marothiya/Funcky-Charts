...
const AddDataSet = ({legends,setLegends,dataSet,setDataSet}) => {
    ...
    return (
        <div className="AddDataSet">
            <div>
                <button onClick={()=> { toggleDataset==="none"?setToggleDataset("block"):setToggleDataset("none")}} style={{margin:"0px auto"}}>Datasets</button>
                <div style={{display:toggleDataset, scrollBehavior:"smooth"}}>
