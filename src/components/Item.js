          ...
          <div className="customize">
                <form className="form">
                    <div className="customs">
                        ...
                        <input className='customize-input' value={settings.xText}  type="text" id="x-axis" name="xText" style={{width: "40%"}} onChange={handleSettingChange}/>
                    ...
                    <div className="customs">
                        ...
                        <input className='setting-input'  value={settings.yText} type="text" id="y-axis" name="yText" style={{width: "40%"}} onChange={handleSettingChange}/>
                        <div style={{width: "50%",textAlign:"end"}}>
                            <label className="switch">
                    ...
                    <div className="customs">
                        ...
                        <input className='setting-input'  value={settings.borderWidth} type="number" id="width" name="borderWidth" onChange={handleSettingChange} /*style={{width: "8%"}}*//>
                    ...
                    <div className="customs">
                        ...
                        <input className='setting-input'  value={settings.hitRadius} type="number" id="hit_radius" name="hitRadius" onChange={handleSettingChange}  /*style={{width: "8%"}}*//>
                        <div style={{width: "67%",textAlign:"end"}}>
                            <label className="switch">
                            <input type="checkbox" defaultChecked/>
                            <span className="slider round"></span>
                    ...
                    <div className="customs">
                        ...
                        <input className='setting-input' value={settings.barThickness} type="number" id="bar_thickness" name="barThickness"  onChange={handleSettingChange} /*style={{width: "8%"}}*//>
                        <div style={{width: "67%",textAlign:"end"}}>
                            <label className="switch">
                            <input type="checkbox" defaultChecked/>
                            <span className="slider round"></span>
                    ...
                    <div className="customs">
                        ...
                        <select id="point_style"  value={settings.pointStyle} style={{width: "15%"}} name="pointStyle" onChange={handleSettingChange}>
